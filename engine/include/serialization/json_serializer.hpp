...
public:
  ...
  */
  ...
  is appended to the array
  */
  bool SetString(const char *name, s_size name_length, const char *value,
                 s_size length) final;
  /*
...
private:
  ...
  template <typename T> bool IsType(const char *name) const;

  /* Get an entry of type T (Only primitives and no pointers)*/
  template <typename T> bool GetType(const char *name, T *result) const;
  ...
  static constexpr s_size kVersionEntryNameLength =
      sizeof(kVersionEntryName) - 1;
...
template <typename T> bool JsonSerializer::IsType(const char *name) const {
  // We are inside an array
  if (IsInsideArray()) {
...
inline bool JsonSerializer::SetBool(const char *name, s_size name_length,
                                    bool value) {
...
inline bool JsonSerializer::SetUint(const char *name, s_size name_length,
                                    unsigned value) {
...
inline bool JsonSerializer::SetInt(const char *name, s_size name_length,
                                   int value) {
...
inline bool JsonSerializer::SetUint64(const char *name, s_size name_length,
                                      uint64_t value) {
...
inline bool JsonSerializer::GetUint64(const char *name,
                                      uint64_t *result) const {
  return GetType<uint64_t>(name, result);
}

inline bool JsonSerializer::SetInt64(const char *name, s_size name_length,
                                     int64_t value) {
...
inline bool JsonSerializer::SetDouble(const char *name, s_size name_length,
                                      double value) {
